...
Para manter o histórico do projeto organizado, utilize o padrão [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0/):
...
fix(index): corrigir bug no carregamento das tarefas
